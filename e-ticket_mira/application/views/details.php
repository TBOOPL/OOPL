			...
			<div class="media">
				...
				<div id="detail-body" class="media-body">
					...
					<div class="detail-rating">
						<h4>Rating:
						<?php for ($k=1; $k<=round($detail->getRating());$k++){?>
							<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
						<?php } echo $detail->getRating();?> / 5.0
						</h4>
					</div>	
					...
					<div class="detail-buttons">
						...
						<?php
							if($logged_in){
								echo site_url('buy/ticket/'.$detail->getId().'/'.'ny');
							}else {
								echo site_url("login/");
							}
						?>" role="button">Buy Ticket</a>
						<a class="btn btn-primary btn-lg fancybox-media" href="<?php echo $detail->getTrailer();?> role="button">Watch Trailer</a>
