...
<body>
	<h1>fancyBox</h1>
	<?php echo base_url('assets/fancyBox/demo/'); ?>
	<p>This is a demonstration. More information and examples: <a href="http://fancyapps.com/fancybox/">www.fancyapps.com/fancybox/</a></p>

	<h3>Simple image gallery</h3>
	<p>
		<a class="fancybox" href="<?php echo(base_url('assets/fancyBox/demo/')).'/' ?>1_s.jpg" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet"><img src="<?php echo(base_url('assets/fancyBox/demo/')).'/' ?>1_s.jpg" alt="" /></a>

		<a class="fancybox" href="<?php echo(base_url('assets/fancyBox/demo/')).'/' ?>2_b.jpg" data-fancybox-group="gallery" title="Etiam quis mi eu elit temp"><img src="<?php echo(base_url('assets/fancyBox/demo/')).'/' ?>2_b.jpg" alt="" /></a>
	...
	<ul>
		<li><a class="fancybox-media" href="http://www.youtube.com/watch?v=opj24KnzrWo" role="button">Youtube</a></li>
