        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
          <div class="container">
            ...
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
              ...
              <a class="navbar-brand" href="<?php echo site_url('home/')?>">Tiket Nonton</a>
            </div>
		...
		<div class="item <?php if ($count==0) echo "active" ?>">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><?php echo substr("".$i->getDesc()."", 0,180); ?>...</p>
              <p><a class="btn btn-lg btn-default" href="<?php echo site_url('details/movieDetails/'.$i->getId()) ?>" role="button">Details</a></p>
            </div>
          </div>
        </div>
	<?php
